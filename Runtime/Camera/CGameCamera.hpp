...
public:
  DEFINE_ENTITY
  CGameCamera(TUniqueId, bool active, std::string_view name, const CEntityInfo& info, const zeus::CTransform4f& xf,
  ...
  virtual void Reset(const zeus::CTransform4f&, CStateManager& mgr) = 0;

  zeus::CMatrix4f GetPerspectiveMatrix() const;
  zeus::CVector3f ConvertToScreenSpace(const zeus::CVector3f&) const;
  zeus::CTransform4f ValidateCameraTransform(const zeus::CTransform4f&, const zeus::CTransform4f&) const;
