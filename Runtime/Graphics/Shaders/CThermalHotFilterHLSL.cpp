...
TShader<CThermalHotFilter>::IDataBindingFactory* CThermalHotFilter::Initialize(boo::D3DDataFactory::Context& ctx)
{
...
template <>
void CThermalHotFilter::Shutdown<boo::D3DDataFactory>()
{
    s_VtxFmt.reset();
    s_Pipeline.reset();
}
