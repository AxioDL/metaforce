...
CFinalInput::CFinalInput(int cIdx, float dt, const boo2::DolphinControllerState& data, const CFinalInput& prevInput,
...
, x2c_b24_A(data.m_btns & uint16_t(boo2::EDolphinControllerButtons::A))
, x2c_b25_B(data.m_btns & uint16_t(boo2::EDolphinControllerButtons::B))
, x2c_b26_X(data.m_btns & uint16_t(boo2::EDolphinControllerButtons::X))
, x2c_b27_Y(data.m_btns & uint16_t(boo2::EDolphinControllerButtons::Y))
, x2c_b28_Z(data.m_btns & uint16_t(boo2::EDolphinControllerButtons::Z))
, x2c_b29_L(data.m_btns & uint16_t(boo2::EDolphinControllerButtons::L))
, x2c_b30_R(data.m_btns & uint16_t(boo2::EDolphinControllerButtons::R))
, x2c_b31_DPUp(data.m_btns & uint16_t(boo2::EDolphinControllerButtons::Up))
, x2d_b24_DPRight(data.m_btns & uint16_t(boo2::EDolphinControllerButtons::Right))
, x2d_b25_DPDown(data.m_btns & uint16_t(boo2::EDolphinControllerButtons::Down))
, x2d_b26_DPLeft(data.m_btns & uint16_t(boo2::EDolphinControllerButtons::Left))
, x2d_b27_Start(data.m_btns & uint16_t(boo2::EDolphinControllerButtons::Start))
...
, x24_anaLeftTriggerP(DLTrigger() && !prevInput.DLTrigger())
, x28_anaRightTriggerP(DRTrigger() && !prevInput.DRTrigger())
, x2c_b31_DPUp(data.m_specialKeys[size_t(boo2::Keycode::UP)])
, x2d_b24_DPRight(data.m_specialKeys[size_t(boo2::Keycode::RIGHT)])
, x2d_b25_DPDown(data.m_specialKeys[size_t(boo2::Keycode::DOWN)])
, x2d_b26_DPLeft(data.m_specialKeys[size_t(boo2::Keycode::LEFT)])
, x2d_b28_PA(DA() && !prevInput.DA())
, x2d_b29_PB(DB() && !prevInput.DB())
, x2d_b30_PX(DX() && !prevInput.DX())
, x2d_b31_PY(DY() && !prevInput.DY())
