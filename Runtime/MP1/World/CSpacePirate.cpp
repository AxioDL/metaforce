...
, x14_hearNoiseRange(in.readFloatBig())
, x18_flags(in.readUint32Big())
, x1c_(in.readBool())
, x20_mainProjectileInfo(in)
, x48_(CSfxManager::TranslateSFXID(in.readUint32Big()))
, x4c_(in)
, x68_(in.readFloatBig())
, x6c_(in)
, x94_(in.readFloatBig())
, x98_ragdollThudSfx(CSfxManager::TranslateSFXID(in.readUint32Big()))
, x9c_averageNextShotTime(in.readFloatBig())
, xa0_nextShotTimeVariation(in.readFloatBig())
, xa4_(CSfxManager::TranslateSFXID(in.readUint32Big()))
, xa8_aimDelayTime(in.readFloatBig())
, xac_firstBurstCount(in.readUint32Big())
, xb0_minCloakAlpha(in.readFloatBig())
, xb4_maxCloakAlpha(in.readFloatBig())
, xb8_(in.readFloatBig())
, xbc_(in.readFloatBig())
, xc0_(CSfxManager::TranslateSFXID(in.readUint32Big()))
...
, x8b8_minCloakAlpha(x568_pirateData.xb0_minCloakAlpha)
, x8bc_maxCloakAlpha(x568_pirateData.xb4_maxCloakAlpha)
, x8c0_(x568_pirateData.xb8_)
, x8c4_aimDelayTimer(x568_pirateData.xa8_aimDelayTime) {
...
void CSpacePirate::FireProjectile(float dt, CStateManager& mgr) {
  ...
  if (!x400_25_alive) {
    LaunchProjectile(gunXf, mgr, 6, EProjectileAttrib::None, false, {}, 0xffff, false, zeus::CVector3f::skOne);
  }
}
...
void CSpacePirate::UpdateAttacks(float dt, CStateManager& mgr) {
  bool reset = true;
  if ((!x400_25_alive ||
       (x450_bodyController->GetBodyStateInfo().GetCurrentState()->CanShoot() && x637_29_ && !x634_27_melee &&
...
void CSpacePirate::UpdateAimBodyState(float dt, CStateManager& mgr) {
  if (x400_25_alive && x637_25_ && !x637_29_ && !x450_bodyController->IsFrozen() && !x634_27_melee && !x85c_ragDoll &&
      (!x635_26_ || x639_28_) && x31c_faceVec.z() <= 0.f) {
...
void CSpacePirate::Think(float dt, CStateManager& mgr) {
  ...
  if (x858_ragdollDelayTimer > 0.f) {
    ...
    if (x858_ragdollDelayTimer <= 0.f) {
      if (!x85c_ragDoll) {
        x85c_ragDoll =
            std::make_unique<CPirateRagDoll>(mgr, this, x568_pirateData.x98_ragdollThudSfx,
...
void CSpacePirate::KnockBack(const zeus::CVector3f&, CStateManager&, const CDamageInfo& info, EKnockBackType type,
...
bool CSpacePirate::Leash(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::OffLine(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::Attacked(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::InRange(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::SpotPlayer(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::PatternOver(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::PatternShagged(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::AnimOver(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::ShouldAttack(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::ShouldJumpBack(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::Stuck(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::Landed(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::HearShot(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::HearPlayer(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::CoverCheck(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::CoverFind(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::CoverBlown(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::CoverNearlyBlown(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::CoveringFire(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::LineOfSight(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::AggressionCheck(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::ShouldDodge(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::ShouldRetreat(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::ShouldCrouch(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::ShouldMove(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::ShotAt(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::HasTargetingPoint(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::ShouldWallHang(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::StartAttack(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::BreakAttack(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::ShouldStrafe(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::ShouldSpecialAttack(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::LostInterest(CStateManager& mgr, float arg) { return false; }

bool CSpacePirate::BounceFind(CStateManager& mgr, float arg) { return false; }
...
CProjectileInfo* CSpacePirate::GetProjectileInfo() { return &x568_pirateData.x20_mainProjectileInfo; }
